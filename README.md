...
Currently building the toolkit in Houdini LC until I am happy with the toolkit. Instead, get all the kinks worked out and then 
make a commercial version, then waste money and time. 

So far this tool is in its V.3 Build 

So far, this toolkit can build your standard ball and stick/wireframe models, space-filling diagrams, and ribbon models. As well as:
...
- Application of atomic properties
